...
#include "tcan_can_device/SdoMsg.hpp"
...
class SDOSetCANBitrate : public SdoMsg {
 public:
  SDOSetCANBitrate(const uint32_t nodeId, const uint32_t bitrate) : SdoMsg(nodeId, SdoMsg::Command::WRITE_2_BYTE, 0x2001, 0x00, bitrate) {}
...
class SDOShutdown : public SdoMsg {
 public:
  SDOShutdown(const uint32_t nodeId) : SdoMsg(nodeId, SdoMsg::Command::WRITE_2_BYTE, 0x6040, 0x00, 0x06) {}
...
class SDOSwitchOn : public SdoMsg {
 public:
  SDOSwitchOn(const uint32_t nodeId) : SdoMsg(nodeId, SdoMsg::Command::WRITE_2_BYTE, 0x6040, 0x00, 0x07) {}
...
class SDOEnableOperation : public SdoMsg {
 public:
  SDOEnableOperation(const uint32_t nodeId) : SdoMsg(nodeId, SdoMsg::Command::WRITE_2_BYTE, 0x6040, 0x00, 0x0F) {}
...
class SDODisableOperation : public SdoMsg {
 public:
  SDODisableOperation(const uint32_t nodeId) : SdoMsg(nodeId, SdoMsg::Command::WRITE_2_BYTE, 0x6040, 0x00, 0x07) {}
...
class SDOFaultReset : public SdoMsg {
 public:
  SDOFaultReset(const uint32_t nodeId) : SdoMsg(nodeId, SdoMsg::Command::WRITE_2_BYTE, 0x6040, 0x00, 0x80) {}
...
//////////////////////////////////////////////////////////////////////////////
class SDOSetDigitalInputFunctionalitiesPolarity : public SdoMsg {
 public:
...
//////////////////////////////////////////////////////////////////////////////
class SDOSetDigitalInputFunctionalitiesExecutionMask : public SdoMsg {
 public:
...
class SDOSetGuardTime : public SdoMsg {
 public:
  SDOSetGuardTime(const uint32_t nodeId, const uint32_t time_ms) : SdoMsg(nodeId, SdoMsg::Command::WRITE_2_BYTE, 0x100C, 0x00, time_ms) {}
...
class SDOReadProducerHeartbeatTime : public SdoMsg {
 public:
  SDOReadProducerHeartbeatTime(const uint32_t nodeId) : SdoMsg(nodeId, SdoMsg::Command::READ, 0x1017, 0x00, 0x0) {}
...
class SDOSetCOBIDSYNC : public SdoMsg {
 public:
  SDOSetCOBIDSYNC(const uint32_t nodeId, const uint32_t ID) : SdoMsg(nodeId, SdoMsg::Command::WRITE_4_BYTE, 0x1005, 0x00, ID) {}
...
class SDOSaveAllParameters : public SdoMsg {
 public:
  SDOSaveAllParameters(const uint32_t nodeId) : SdoMsg(nodeId, SdoMsg::Command::WRITE_4_BYTE, 0x1010, 0x01, 0x65766173) {}
...
class SDORestoreAllDefaultParameters : public SdoMsg {
 public:
  SDORestoreAllDefaultParameters(const uint32_t nodeId) : SdoMsg(nodeId, SdoMsg::Command::WRITE_4_BYTE, 0x1011, 0x01, 0x64616F6C) {}
...
class SDOTxPDO1Disable : public SdoMsg {
 public:
  SDOTxPDO1Disable(const uint32_t nodeId) : SdoMsg(nodeId, SdoMsg::Command::WRITE_4_BYTE, 0x1800, 0x01, 0x80000180 + nodeId) {}
...
class SDOTxPDO1ConfigureCOBID : public SdoMsg {
 public:
  SDOTxPDO1ConfigureCOBID(const uint32_t nodeId) : SdoMsg(nodeId, SdoMsg::Command::WRITE_4_BYTE, 0x1800, 0x01, 0x40000180 + nodeId) {}
...
class SDOTxPDO1SetTimer : public SdoMsg {
 public:
  SDOTxPDO1SetTimer(const uint32_t nodeId, const uint32_t ms) : SdoMsg(nodeId, SdoMsg::Command::WRITE_2_BYTE, 0x1800, 0x05, ms) {}
...
class SDOTxPDO2ConfigureCOBID : public SdoMsg {
 public:
  SDOTxPDO2ConfigureCOBID(const uint32_t nodeId) : SdoMsg(nodeId, SdoMsg::Command::WRITE_4_BYTE, 0x1801, 0x01, 0x40000280 + nodeId) {}
  ~SDOTxPDO2ConfigureCOBID() override = default;
};
//////////////////////////////////////////////////////////////////////////////
class SDOTxPDO2Disable : public SdoMsg {
 public:
  SDOTxPDO2Disable(const uint32_t nodeId) : SdoMsg(nodeId, SdoMsg::Command::WRITE_4_BYTE, 0x1801, 0x01, 0x80000280 + nodeId) {}
...
class SDOTxPDO2SetTimer : public SdoMsg {
 public:
  SDOTxPDO2SetTimer(const uint32_t nodeId, const uint32_t ms) : SdoMsg(nodeId, SdoMsg::Command::WRITE_2_BYTE, 0x1801, 0x05, ms) {}
...
class SDOTxPDO3ConfigureCOBID : public SdoMsg {
 public:
  SDOTxPDO3ConfigureCOBID(const uint32_t nodeId) : SdoMsg(nodeId, SdoMsg::Command::WRITE_4_BYTE, 0x1802, 0x01, 0x40000380 + nodeId) {}
  ~SDOTxPDO3ConfigureCOBID() override = default;
};
//////////////////////////////////////////////////////////////////////////////
class SDOTxPDO3Disable : public SdoMsg {
 public:
  SDOTxPDO3Disable(const uint32_t nodeId) : SdoMsg(nodeId, SdoMsg::Command::WRITE_4_BYTE, 0x1802, 0x01, 0x80000380 + nodeId) {}
...
class SDOTxPDO3SetTimer : public SdoMsg {
 public:
  SDOTxPDO3SetTimer(const uint32_t nodeId, const uint32_t ms) : SdoMsg(nodeId, SdoMsg::Command::WRITE_2_BYTE, 0x1802, 0x05, ms) {}
...
class SDOTxPDO4ConfigureCOBID : public SdoMsg {
 public:
  SDOTxPDO4ConfigureCOBID(const uint32_t nodeId) : SdoMsg(nodeId, SdoMsg::Command::WRITE_4_BYTE, 0x1803, 0x01, 0x40000480 + nodeId) {}
  ~SDOTxPDO4ConfigureCOBID() override = default;
};
//////////////////////////////////////////////////////////////////////////////
class SDOTxPDO4Disable : public SdoMsg {
 public:
  SDOTxPDO4Disable(const uint32_t nodeId) : SdoMsg(nodeId, SdoMsg::Command::WRITE_4_BYTE, 0x1803, 0x01, 0xFFFFFFFF) {}
...
class SDOTxPDO4SetTimer : public SdoMsg {
 public:
  SDOTxPDO4SetTimer(const uint32_t nodeId, const uint32_t ms) : SdoMsg(nodeId, SdoMsg::Command::WRITE_2_BYTE, 0x1803, 0x05, ms) {}
...
class SDORxPDO1ConfigureCOBID : public SdoMsg {
 public:
  SDORxPDO1ConfigureCOBID(const uint32_t nodeId) : SdoMsg(nodeId, SdoMsg::Command::WRITE_4_BYTE, 0x1400, 0x01, 0x40000200 + nodeId) {}
...
class SDORxPDO1Disable : public SdoMsg {
 public:
  SDORxPDO1Disable(const uint32_t nodeId) : SdoMsg(nodeId, SdoMsg::Command::WRITE_4_BYTE, 0x1400, 0x01, 0xFFFFFFFF) {}
...
class SDORxPDO2ConfigureCOBID : public SdoMsg {
 public:
  SDORxPDO2ConfigureCOBID(const uint32_t nodeId) : SdoMsg(nodeId, SdoMsg::Command::WRITE_4_BYTE, 0x1401, 0x01, 0x40000300 + nodeId) {}
...
class SDORxPDO2Disable : public SdoMsg {
 public:
  SDORxPDO2Disable(const uint32_t nodeId) : SdoMsg(nodeId, SdoMsg::Command::WRITE_4_BYTE, 0x1401, 0x01, 0xFFFFFFFF) {}
...
class SDORxPDO3ConfigureCOBID : public SdoMsg {
 public:
  SDORxPDO3ConfigureCOBID(const uint32_t nodeId) : SdoMsg(nodeId, SdoMsg::Command::WRITE_4_BYTE, 0x1402, 0x01, 0x40000400 + nodeId) {}
...
class SDORxPDO3Disable : public SdoMsg {
 public:
  SDORxPDO3Disable(const uint32_t nodeId) : SdoMsg(nodeId, SdoMsg::Command::WRITE_4_BYTE, 0x1402, 0x01, 0xFFFFFFFF) {}
...
class SDORxPDO4ConfigureCOBID : public SdoMsg {
 public:
  SDORxPDO4ConfigureCOBID(const uint32_t nodeId) : SdoMsg(nodeId, SdoMsg::Command::WRITE_4_BYTE, 0x1403, 0x01, 0x40000500 + nodeId) {}
...
class SDORxPDO4Disable : public SdoMsg {
 public:
  SDORxPDO4Disable(const uint32_t nodeId) : SdoMsg(nodeId, SdoMsg::Command::WRITE_4_BYTE, 0x1403, 0x01, 0xFFFFFFFF) {}
...
class SDOReadErrorRegister : public SdoMsg {
 public:
  SDOReadErrorRegister(const uint32_t nodeId) : SdoMsg(nodeId, SdoMsg::Command::READ, 0x1001, 0x00, 0x0) {}
